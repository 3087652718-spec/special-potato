...
export const projects: Project[] = [
  {
    ...
    name: "智能静音光诱灭蚊器",
    category: "家电产品 / 智能硬件",
    intro: "面向卧室与居家环境的智能灭蚊产品设计，强调静音、柔和光诱与家居融合感。",
    ...
    overview: "本项目围绕卧室夜间灭蚊场景展开，尝试将传统工具型灭蚊灯转化为更安静、柔和、适合长期摆放的家居小电器。方案结合光诱、风吸、隐藏式捕蚊仓与夜灯模式，在满足灭蚊功能的同时，降低噪音、强光和清洁维护带来的使用负担。",
    ...
    cmf: [
      {
        ...
        material: "ABS / PC",
        craft: "哑光喷涂 / 细砂纹",
        purpose: "降低工具感，增强卧室家居融合感。",
        note: "用于主体外壳，传达干净、柔和、低存在感的家居属性。雾面质感能够减少强反光与廉价塑料感，使产品更接近现代小家电的设计语言。"
      },
      {
        ...
        material: "半透明 PC",
        craft: "磨砂扩散纹理",
        purpose: "柔化光线，避免夜间强刺激。",
        note: "用于上部灯罩区域，通过半透明材质和磨砂扩散纹理弱化内部灯源与结构暴露，使灯光以更柔和的方式扩散，提升卧室夜间使用的舒适度。"
      },
      {
        ...
        purpose: "避免紫光大面积外露，降低视觉刺激。",
        note: "将诱蚊紫光控制在内部风道和捕蚊区域中，避免传统灭蚊灯常见的大面积紫光外露问题，在保留光诱功能识别度的同时减少夜间视觉干扰。"
      }
    ],
  ...
  },
  {
    ...
    intro: "面向养老院与护理场景的送药机器人设计，提升药品配送效率与护理安全性。",
    ...
    overview: "本项目旨在重塑医疗机构末端给药流程的安全基建。系统通过整合独立物理锁控矩阵与强制电子鉴权技术，全面接管繁杂的送药任务；不仅释放了护理人力资源，更从根本上筑牢极端老护比环境下的用药安全防线。",
    background: "当前养老机构面临 1:30 的极端老护比，单层发药日均耗时高达 180 分钟。长期的体力消耗与心智耗竭导致人工核对防线生理性失效，诱发 16% 至 27% 的极高给药差错率，亟需引入系统层面的风控干预。",
    painPoints: [
      {
        title: "纯体力透支与护理缺位",
        body: "护士周均超时加班 8.3 小时，单层纯发药耗时达 180 分钟，专业护理的时间与精力被低效的物理跑腿严重透支。"
      },
      {
        title: "巡视中断与记忆断层",
        body: "高达 79% 的日常给药巡视任务会遭遇突发事件打断，人工记忆断层极易在二次核对时诱发致命的错漏发事故。"
      },
      {
        title: "多重用药的视觉盲区",
        body: "长者平均患有 3 至 5 种慢病，单次服药达 8 至 15 粒。高度相似的药品外观导致护士在疲劳状态下的识别错误率呈指数级上升。"
      },
      {
        title: "证据链条与数据断层",
        body: "传统给药动作缺乏实时的数据闭环，发药时间未能精确到秒级落账，导致机构在面临医疗纠纷时缺乏不可篡改的照护证据链。"
      }
    ],
    goals: [
      {
        title: "角色重构：释放专业护理价值",
        body: "由智能系统全面接管高频的跑腿与机械核对工作，将护士的时间与精力重新导向高价值的专业照护与情感陪伴。"
      },
      {
        title: "绝对隔离：一人一仓的物理防线",
        body: "系统内置 30 个以上的独立运作物理矩阵药仓，强制落实“一人一仓”原则，从物理源头彻底切断多人份药物交叉错配风险。"
      },
      {
        title: "强制鉴权：零认知的防呆交互",
        body: "深度整合人脸与 NFC 双重生物 / 物理鉴权模块，配合直觉化的光效引导，以系统的强制解锁取代人工记忆，降维消解核验负担。"
      },
      {
        title: "机构装甲：全天候的稳定基建",
        body: "采用医疗级抗污材质与低重心底盘布局，构建抵御复杂通道高频碰撞的坚固装甲，保障 24 小时不间断的自主巡航与闭环交付。"
      }
    ],
    ...
    summary: "设计不试图替代护理人员，而是把重复配送和状态确认标准化，让护理工作更有余量。"
  },
  {
    slug: "guide-robot",
    index: "03",
